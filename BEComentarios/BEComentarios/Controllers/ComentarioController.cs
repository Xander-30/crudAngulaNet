...
namespace BEComentarios.Controllers
{
    ...
    {
        private readonly AplicationDiviContext _context;
        //crearemos un controlador 
        public ComentarioController(AplicationDiviContext context)
        {
            _context = context;
        }

        //este metodo get sera el responsable de devolver el listado de elementos
